...
class NameHashGenerator:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.base_hashmap_path = config.get("base_hashmap_path", "")
        ...
        self.base_map_2606: Dict[str, str] = {}
    ...
    def run(self) -> Dict[str, str]:
        ...
        if self.usmap_path and os.path.exists(self.usmap_path):
            print(f"\n[1/5] Parsing Reference USMAP: {os.path.basename(self.usmap_path)}...")
        ...
        print("\n[5/5] Performing Multi-SDK Structural Diffing & Lineage Tracking...")
        known_combined = dict(self.base_map_2606)
        ...
        self.all_mappings = {}
        self.all_mappings.update(self.base_map_2606)
    ...
    def _load_baselines(self):
        if self.base_hashmap_path and os.path.exists(self.base_hashmap_path):
            with open(self.base_hashmap_path, "r", encoding="utf-8") as f:
                raw_map = json.load(f)
            self.base_map_2606 = {
                k: v.strip()
            ...
            print(f"Loaded baseline 2606 hashmap: {len(self.base_map_2606)} entries.")
